...
function AttachmentBubble({ m, mine }) {
  ...
  if (type === "image") {
    return <img src={url} alt={m.attachment_name || ""} style={{ maxWidth: 200, borderRadius: 12, display: "block" }} />;
  }
  if (type === "video") {
    return <video src={url} controls style={{ maxWidth: 220, borderRadius: 12, display: "block" }} />;
  }
  if (type === "audio") {
    return <audio src={url} controls style={{ width: 220 }} />;
  }
  return (
    <a
      href={url}
